...
public class DeptServiceV1 {
	...
	protected void viewDetail(DeptDTO dto) {
		System.out.println("================================");
		System.out.println("상호:" + dto.getD_name());
		System.out.println("대표:" + dto.getD_ceo());
		System.out.println("전화:" + dto.getD_tel());
		System.out.println("주소:" + dto.getD_addr());
		System.out.println("업종: 슈퍼마켓");
		System.out.println("업태: 도소매");
		System.out.println("사업자번호: 409-01-0001");
		System.out.println("담당자: 홍길동");
		System.out.println("담당자 직통 전화: 010-123-1234");
