...
public class IolistServiceV3 extends IolistServiceV1 {
	...
	protected void update() {
		...
		try {
			...
			System.out.println("SEQ 형식이 틀렸음");
			return;
		}
		
		IolistDTO dto = iolistDao.findById(longSEQ);

		while (true) {
			System.out.printf("거래구분[%s] (1:매입, 2:매출, -1:종료 >> ", dto.getIo_inout());
